...
[Visual Studio Code](https://www.sublimetext.com/) is a free, open source AI code editor. It integrates Ardent via the [vscode-nsis](https://marketplace.visualstudio.com/items?itemName=idleberg.nsis) extension. Users of VS Codium, Cursor, Antigravity ort Windsurf install it from [Open VSX](https://open-vsx.org/extension/idleberg/nsis) instead.
